    ...
    <div className="recon-card">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Proactive alerts triggered for fee overcharges, volume spikes, and missing payouts.</p>
        </div>
      ...
      <div className="space-y-4">
        {alerts.map((alert, idx) => (
          <div
            key={idx}
            className="p-4 rounded-xl bg-[var(--bg-input)] border border-[var(--border-dim)] flex items-start gap-3"
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-[11px] font-medium text-emerald-500 bg-emerald-500/10 p-2.5 rounded-lg border border-emerald-500/20">
